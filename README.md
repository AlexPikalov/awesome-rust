...
* NoSQL [[nosql](https://crates.io/keywords/nosql)]
  * Cassandra [[cassandra](https://crates.io/keywords/cassandra), [cql](https://crates.io/keywords/cql)]
    * [tupshin/cassandra-rust](https://github.com/tupshin/cassandra-rs) — [Cassandra](http://cassandra.apache.org)
    * [AlexPikalov/cdrs](https://github.com/AlexPikalov/cdrs) — [CDRS](https://crates.io/crates/cdrs) Cassandra Driver written in Rust. [![Build Status](https://travis-ci.org/AlexPikalov/cdrs.svg?branch=master)](https://travis-ci.org/AlexPikalov/cdrs)
